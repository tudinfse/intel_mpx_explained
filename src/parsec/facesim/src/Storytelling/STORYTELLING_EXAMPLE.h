...
public:
	...
	STORYTELLING_EXAMPLE(std::string data_dir)
	{
		output_directory = "Storytelling/output";
		control_directory = data_dir + "/Face_Data/Motion_Data/Storytelling_Controls";

		// Simulation source
		model_directory = data_dir + "/Face_Data/Eftychis_840k";
